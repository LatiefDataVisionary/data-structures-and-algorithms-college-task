...
class ToDoApp:
    ...
    def create_widgets(self):
        ...
        # Adjust the tag colors for better transparency
        self.tree.tag_configure('belum_selesai', background='#FFFFFF80')  # Light grey with 50% opacity
        self.tree.tag_configure('selesai', background='#90EE9080')  # Light green with 50% opacity
