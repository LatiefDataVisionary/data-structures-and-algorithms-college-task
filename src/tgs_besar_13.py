...
class ToDoApp:
    ...
    def create_widgets(self):
        ...
        # Add buttons for task operations above the table
        ...
        # Configure transparent Treeview
    ...
    def set_treeview_style(self, event):
        self.tree.configure(style="Transparent.Treeview")
        self.tree.tag_configure("Transparent.Treeview", background=self.root.cget("bg"))
        style = ttk.Style()
        style.configure("Transparent.Treeview", background=self.root.cget("bg"), fieldbackground=self.root.cget("bg"), foreground="white", font=('Arial', 12))
        style.map("Transparent.Treeview", background=[("selected", "#4B8BBE")])
